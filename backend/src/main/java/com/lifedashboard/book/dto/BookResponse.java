...
public record BookResponse(Long id,Long contentId,String title,String author,BookFormat bookFormat,Integer pageCount,
        Integer releaseYear,String genre,String coverUrl,String description,Long libraryEntryId,UserContentStatus status,
        Short rating,boolean favorite,String personalNote,Instant startedAt,Instant completedAt,Integer currentPage,
