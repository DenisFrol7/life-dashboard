...
export function AnimeDetailsPage() {
  ...
  return <div className="series-details-page anime-details-page">
    ...
    {editing && <AnimeForm anime={anime} onClose={() => setEditing(false)} onSaved={() => { setEditing(false); void load() }} onDeleted={() => navigate('/anime', { replace: true })} />}
