...
export type AnimeSummary = { id: number; title: string; originalTitle: string | null; releaseYear: number | null; coverUrl: string | null; releaseStatus: ReleaseStatus; userStatus: LibraryStatus | null; rating: number | null; favorite: boolean; seasonCount: number; episodeCount: number; watchedEpisodeCount: number }
